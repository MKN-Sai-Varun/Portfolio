  ...
  const education = [
    {
      ...
      achievements: ['Dean\'s List', 'Hackathon Winner', 'Tech Club Lead'],
    ...
    },
    {
      ...
      coursework: ['Advanced Mathematics', 'Physics', 'Computer Science', 'Chemistry'],
      achievements: ['School Topper', 'Science Olympiad', 'Coding Competition Winner'],
